...
const Favoris = () => {
  ...
  return (
    <div className="container mx-auto p-6">
      <h1 className="text-3xl font-bold text-green-600 mb-8">Vos Favoris</h1>
        ...
        <div className="lg:w-2/3">
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            {cartItems.map((item) => (
              <div
                key={item.id}
                className="flex items-center justify-between p-2 gap-2 border-b"
              >
                <img
                  src={item.image}
                  alt={item.name}
                ...
                <button className=" bg-green-500 text-white font-semibold p-2 rounded-md hover:bg-green-600 transition-colors">
                  Panier
                </button>
              </div>
            ))}
